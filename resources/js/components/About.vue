    ...
    <div class="theme-layout">
                                    ...
                                    <div class="vehicul-post">
                                        <div class="vehicul-thumb">
                                            ...
                                            <div class="vehicul-post-detail">
                                                ...
                                                <h2><a href="#" title="">Mercedes-Benz</a></h2>
        ...
        <footer>
            <section class="top-line">
                <div style="background: url(img/footer.jpg) repeat scroll 50% 422.28px transparent;" class="parallax scrolly-invisible blackish"></div><!-- PARALLAX BACKGROUND IMAGE -->   
                <div class="container">
                    <div class="row">                        
